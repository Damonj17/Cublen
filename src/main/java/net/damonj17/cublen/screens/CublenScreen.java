package net.damonj17.cublen.screens;
...
@LuaWhitelist
public class CublenScreen extends AbstractPanelScreen {
    public CublenScreen(Screen parentScreen) {
        super(parentScreen, Component.translatable("cublen.gui.cublenscreen"));
    }
    private Button cublenButton;
    @Override
    protected void init() {
        super.init();
        ...
        addRenderableWidget(cublenButton = new Button(buttX - 48, buttY, 20, 20, 0, 0, 20, new FiguraIdentifier("textures/gui/play.png"), 60, 20, Component.translatable("cublen.gui.cublenscreen.next.tooltip"), button -> {
            onClose();
        }));
    }
